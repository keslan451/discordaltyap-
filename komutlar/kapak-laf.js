...
exports.run = async (client, msg, args) => {
    let kapak=[
      ...
      "Sen vurursun bela okurlar. Biz vururuz sela okurlar.",
     ...
     if(!member)return msg.channel.send(':no_entry_sign: Birini Etiketle!')
    else{
    msg.channel.send(`${member}, ${kapak[Math.floor(Math.random() * 16)]}`)
    }
  }
