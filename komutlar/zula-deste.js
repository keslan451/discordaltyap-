...
exports.run = (client, message) => {
    ...
    var devtr = devtr[Math.floor(Math.random(1) * devtr.length)]
    const devtr1  = new Discord.RichEmbed()
    ...
    .setDescription(`${devtr}`)
    .setFooter(`Desteyi açan (${message.author.username}) Unutma Bunlar Sadece Bir Simülatör Gerçek Hesabına Gelmez | Türk Bot`)
    .setColor("RANDOM")
    return message.channel.sendEmbed(devtr1);
};
exports.conf = {
  enabled: true,
  guildOnly: false,
